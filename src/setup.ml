...
(* OASIS_START *)
(* DO NOT EDIT (digest: 6f060691e60aa30dbec5b39404e1dc14) *)
(*
...
# 1 "/home/trch/software/OCaml/oasis/trunk/src/oasis/OASISString.ml"
...
# 21 "/home/trch/software/OCaml/oasis/trunk/src/oasis/OASISHostPath.ml"
...
# 21 "/home/trch/software/OCaml/oasis/trunk/src/oasis/OASISSection.ml"
...
# 21 "/home/trch/software/OCaml/oasis/trunk/src/oasis/OASISExec.ml"
...
# 21 "/home/trch/software/OCaml/oasis/trunk/src/oasis/OASISFileUtil.ml"
...
let setup_t =
  {
     ...
     package =
       {
          ...
          description =
            Some
              "This is a pure OCaml library to read and write CSV files,\nincluding all extensions used by Excel \226\128\148 eg. quotes, newlines,\n8 bit characters in fields, \\\"0 etc.";
          categories = [];
               ...
               Doc
                 ({
                     ...
                     },
                   {
                      ...
                      doc_title = "API reference for Csv";
                      doc_authors = [];
                      doc_abstract = None;
                      doc_format = OtherDoc;
                      doc_data_files = [];
               ...
               Executable
                 ({
                     ...
                     },
                   {
                      ...
                      bs_path = "examples/";
                      bs_compiled_object = Best;
                      bs_build_depends = [InternalLibrary "csv"];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
                      bs_data_files = [];
                      bs_ccopt = [(OASISExpr.EBool true, [])];
                   ...
                   {exec_custom = false; exec_main_is = "csvtool.ml"; });
               Executable
                 ({
                     cs_name = "example";
                     cs_data = PropList.Data.create ();
               ...
               SrcRepo
                 ({
                     ...
                     },
                   {
                      src_repo_type = Svn;
                      src_repo_location =
                        "svn://svn.forge.ocamlcore.org/svn/csv/trunk";
                      src_repo_browser =
                        Some
     ...
     oasis_version = "0.3.1";
     oasis_digest = Some "cQB#c\015\135\218>Q\218\147\214O\129s";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false;
     };;
